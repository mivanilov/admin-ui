...
class ExampleCrudLazyDataControllerIT extends ControllerITBase {
    ...
    void loadExampleConfigRowsPage() throws Exception {
        ...
        when(exampleConfigService.findPageOfExampleConfigs(2, 1)).thenReturn(new PageImpl(List.of(exampleConfig)));

        MockHttpServletRequestBuilder requestBuilder = post(AppRoutes.EXAMPLE_CRUD_LAZY_LOAD_ROWS_PAGE)
