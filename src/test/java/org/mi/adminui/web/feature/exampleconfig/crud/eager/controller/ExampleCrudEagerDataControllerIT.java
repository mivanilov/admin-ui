...
class ExampleCrudEagerDataControllerIT extends ControllerITBase {
    ...
    void loadExampleConfigRows() throws Exception {
        ...
        when(exampleConfigService.findAll()).thenReturn(List.of(exampleConfig));

        MockHttpServletRequestBuilder requestBuilder = post(AppRoutes.EXAMPLE_CRUD_EAGER_LOAD_ROWS)
